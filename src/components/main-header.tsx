...
export default function MainHeader() {
  ...
  return (
    <header className="px-6 md:px-[10%] py-4">
        ...
        <ul className="hidden md:flex items-center gap-4 lg:gap-6">
          {NavMenu.map((na, idx) => (
            <li key={idx}>
              <Link
                href={na.link}
                className="text-[#f5e6d3]/90 hover:text-[#f5e6d3] transition-colors duration-200 text-base lg:text-lg tracking-wide"
              >
                {na.label}
              </Link>
            </li>
      ...
      {/* Mobile menu panel with fade & slide */}
      <div
            ...
            {NavMenu.map((na, idx) => (
              <li key={idx}>
                <Link
                  ...
                  className="block px-4 py-3 text-[#f5e6d3]/90 hover:text-[#f5e6d3] hover:bg-white/5 transition-colors duration-200"
                >
                  {na.label}
                </Link>
              </li>
